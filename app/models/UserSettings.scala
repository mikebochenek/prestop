...
object UserSettings {
  def default(id: Long) = { new UserSettings(id, "en_US", false, "", 0, MutableList.empty[Cuisine], Option(MutableList.empty[Cuisine]), Option(MutableList.empty[Cuisine]), Option(""), Option(0.0), Option("")) }
